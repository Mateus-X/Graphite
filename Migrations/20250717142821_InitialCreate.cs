    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Dataframes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Dataframes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataframeLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DataframeLines_Dataframes_DataframeId",
                        column: x => x.DataframeId,
                        principalTable: "Dataframes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataframeLines_DataframeId",
                table: "DataframeLines",
                column: "DataframeId");

            migrationBuilder.CreateIndex(
                name: "IX_Dataframes_UserId",
                table: "Dataframes",
                column: "UserId");
        }
